...
use super::super::livedata::live_data;
...
pub fn update_dataframe(
    ...
    let series: Vec<super::TimeSeriesData> = match live_data(sql_connection.clone(), &stock_symbol, &exchange_code) {
        Ok(res) => res,
        Err(error) => {
